...
const tipper1 = new URL("../../../img/JCB.jpg", import.meta.url).href;
const tipper2 = new URL("../../../img/MotorGrader.jpg", import.meta.url).href;
const tipper3 = new URL("../../../img/RoadRoller.jpg", import.meta.url).href;
const tipper4 = new URL("../../../img/Tipper.jpg", import.meta.url).href;
const tipper5 = new URL("../../../img/machine1.jpeg", import.meta.url).href;
      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row items-start gap-6">
          ...
          <div className="md:w-1/2 w-full text-left">
            <h1 className="text-3xl font-bold mb-2">Tipper</h1>
        ...
        <div className="mt-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
            {[tipper1, tipper2, tipper3, tipper4, tipper5].map(
              (image, index) => (
                <img
                  key={index}
                  src={image}
                  alt={`Tipper gallery image ${index + 1}`}
